import type { Component, App as VueApp } from '../react-adapter'
// Adapted from Justineo/vue-clamp tests (MIT), pinned 9f93dbcc.
...
import { createApp } from '../react-adapter'
...
function clampInDemoBlock(block: HTMLElement): HTMLElement {
  ...
  if (!(clampRoot instanceof HTMLElement)) {
    throw new TypeError('Expected the demo clamp root.')
  }
...
function widthInput(container: HTMLElement): HTMLInputElement {
  ...
  if (!(input instanceof HTMLInputElement)) {
    throw new TypeError('Expected the shared line width slider.')
  }
...
function lineTextInput(container: HTMLElement): HTMLTextAreaElement {
  ...
  if (!(input instanceof HTMLTextAreaElement)) {
    throw new TypeError('Expected the shared line demo text input.')
  }
...
function lineTextPresetButtons(container: HTMLElement): HTMLButtonElement[] {
  return [...container.querySelectorAll('[data-line-text-preset]')].map((button) => {
    if (!(button instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the shared line text preset button.')
    }
...
function demoBlock(container: HTMLElement, index: number): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError(`Expected demo block ${index}.`)
  }
...
function locationDemoBlock(container: HTMLElement): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError('Expected the location demo block.')
  }
...
function richHtmlDemoBlock(container: HTMLElement): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError('Expected the rich html demo block.')
  }
...
function richExampleBlock(container: HTMLElement, example: string): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError(`Expected the ${example} rich demo block.`)
  }
...
function richHtmlInput(container: HTMLElement): HTMLTextAreaElement {
  ...
  if (!(input instanceof HTMLTextAreaElement)) {
    throw new TypeError('Expected the rich html textarea.')
  }
...
function richPresetButton(container: HTMLElement, preset: string): HTMLButtonElement {
  ...
  if (!(button instanceof HTMLButtonElement)) {
    throw new TypeError(`Expected the ${preset} rich preset button.`)
  }
...
function richHyphensToggle(container: HTMLElement): HTMLInputElement {
  ...
  if (!(input instanceof HTMLInputElement)) {
    throw new TypeError('Expected the shared rich hyphens toggle.')
  }
...
function sharedControls(container: HTMLElement, surface: DemoSurface): HTMLElement {
  ...
  if (!(controls instanceof HTMLElement)) {
    throw new TypeError(`Expected the ${surface} shared controls.`)
  }
...
function sharedControlsToggle(container: HTMLElement, surface: DemoSurface): HTMLButtonElement {
  ...
  if (!(toggle instanceof HTMLButtonElement)) {
    throw new TypeError(`Expected the ${surface} shared controls toggle.`)
  }
...
function locationRatioInput(container: HTMLElement): HTMLInputElement {
  ...
  if (!(input instanceof HTMLInputElement)) {
    throw new TypeError('Expected the location ratio slider.')
  }
...
function locationPresetButton(container: HTMLElement, preset: string): HTMLButtonElement {
  ...
  if (!(button instanceof HTMLButtonElement)) {
    throw new TypeError(`Expected the ${preset} location preset button.`)
  }
...
function inlineDemoBlock(container: HTMLElement): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError('Expected the inline demo block.')
  }
...
function inlineWidthInput(container: HTMLElement): HTMLInputElement {
  ...
  if (!(input instanceof HTMLInputElement)) {
    throw new TypeError('Expected the inline width slider.')
  }
...
function inlineLocationRatioInput(container: HTMLElement): HTMLInputElement {
  ...
  if (!(input instanceof HTMLInputElement)) {
    throw new TypeError('Expected the inline location ratio slider.')
  }
...
function inlineLocationPresetButton(container: HTMLElement, preset: string): HTMLButtonElement {
  ...
  if (!(button instanceof HTMLButtonElement)) {
    throw new TypeError(`Expected the ${preset} inline location preset button.`)
  }
...
function inlineExampleBlock(container: HTMLElement, example: string): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError(`Expected the ${example} inline example block.`)
  }
...
function inlineRow(scope: ParentNode, mode: 'plain' | 'split'): HTMLElement {
  ...
  if (!(row instanceof HTMLElement)) {
    throw new TypeError(`Expected the ${mode} inline row.`)
  }
...
function wrapDemoBlock(container: HTMLElement): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError('Expected the wrap demo block.')
  }
...
function wrapExampleBlock(container: HTMLElement, example: string): HTMLElement {
  ...
  if (!(block instanceof HTMLElement)) {
    throw new TypeError(`Expected the ${example} wrap example block.`)
  }
...
function wrapWidthInput(container: HTMLElement): HTMLInputElement {
  ...
  if (!(input instanceof HTMLInputElement)) {
    throw new TypeError('Expected the shared wrap width slider.')
  }
...
function copyButton(container: ParentNode, blockId: string): HTMLButtonElement {
  ...
  if (!(button instanceof HTMLButtonElement)) {
    throw new TypeError(`Expected the ${blockId} copy button.`)
  }
...
function surfaceTab(container: HTMLElement, surface: DemoSurface): HTMLButtonElement {
  ...
  if (!(button instanceof HTMLButtonElement)) {
    throw new TypeError(`Expected the ${surface} surface tab.`)
  }
...
function surfaceGuideItem(container: HTMLElement, surface: DemoSurface): HTMLElement {
  ...
  if (!(element instanceof HTMLElement)) {
    throw new TypeError(`Expected the ${surface} surface guide item.`)
  }
...
function surfaceGuideLink(container: HTMLElement, surface: DemoSurface): HTMLAnchorElement {
  ...
  if (!(element instanceof HTMLAnchorElement)) {
    throw new TypeError(`Expected the ${surface} surface guide link.`)
  }
...
function surfaceTooltip(container: HTMLElement, surface: DemoSurface): HTMLElement {
  ...
  if (!(tooltip instanceof HTMLElement)) {
    throw new TypeError(`Expected the ${surface} surface tooltip.`)
  }
...
function componentTabsScroll(container: HTMLElement): HTMLElement {
  ...
  if (!(element instanceof HTMLElement)) {
    throw new TypeError('Expected the component tabs scroller.')
  }
...
function heroTagline(container: HTMLElement): HTMLElement {
  ...
  if (!(element instanceof HTMLElement)) {
    throw new TypeError('Expected the hero tagline.')
  }
...
function heroTaglinePart(container: HTMLElement, part: 'start' | 'body' | 'end'): HTMLElement {
  ...
  if (!(element instanceof HTMLElement)) {
    throw new TypeError(`Expected the hero tagline ${part} segment.`)
  }
...
function referenceShell(container: HTMLElement): HTMLElement {
  ...
  if (!(shell instanceof HTMLElement)) {
    throw new TypeError('Expected the shared reference shell.')
  }
...
function referenceTabsAnchor(container: HTMLElement): HTMLElement {
  ...
  if (!(anchor instanceof HTMLElement)) {
    throw new TypeError('Expected the reference tabs anchor.')
  }
...
function checkboxInBlock(block: HTMLElement, label: string): HTMLInputElement {
  ...
  if (!(input instanceof HTMLInputElement)) {
    throw new TypeError(`Expected the ${label} checkbox.`)
  }
...
async function selectLineEngine(
  ...
  if (!(button instanceof HTMLButtonElement)) {
    throw new TypeError(`Expected the ${engine} LineClamp engine button.`)
  }
...
describe('website demo page', () => {
  it('keeps the workspace line-clamp toggle demo within three visible lines at 585px', async () => {
    const { default: App } = await import('../../../demo/App')
  ...
  it('switches line demo slot copy with the RTL examples', async () => {
    ...
    if (!(firstToggle instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the first demo toggle button.')
    }
    if (!(secondBadge instanceof HTMLElement)) {
      throw new TypeError('Expected the second demo badge.')
    }
  ...
  it('switches between the documented component surfaces and shows their demos', async () => {
    ...
    if (!(splitFileListBody instanceof HTMLElement)) {
      throw new TypeError('Expected the split file-list body element.')
    }
    ...
    if (!(tabsTrigger instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the tabs overflow trigger.')
    }
    ...
    if (!(tabsMenu instanceof HTMLElement)) {
      throw new TypeError('Expected the tabs overflow menu.')
    }
    const firstHiddenTab = tabsMenu.querySelector('.wrap-tabs-menu-item')
    if (!(firstHiddenTab instanceof HTMLElement)) {
      throw new TypeError('Expected at least one hidden tab option.')
    }
    ...
    if (!(reopenedTabsMenu instanceof HTMLElement)) {
      throw new TypeError('Expected the reopened tabs overflow menu.')
    }
    expect(
    ...
    if (!(tabsTriggerAfterRtl instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the tabs overflow trigger after RTL toggle.')
    }
    ...
    if (!(inviteesToggle instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the invitees wrap toggle.')
    }
  ...
  it('opens a stress playground with fps and workload controls', async () => {
    ...
    if (!(openButton instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the stress playground open button.')
    }
    ...
    if (!(richSurfaceButton instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the RichLineClamp stress surface button.')
    }
    ...
    if (!(lineSurfaceButton instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the LineClamp stress surface button.')
    }
    ...
    if (!(graphemeBoundaryButton instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the grapheme stress boundary button.')
    }
    ...
    if (!(heightModeButton instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the height stress limit mode button.')
    }
    ...
    if (
      ...
      throw new TypeError('Expected the LineClamp and Pretext comparison controls.')
    }
    ...
    if (!(resizeStressToggle instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the continuous resize stress control.')
    }
    ...
    if (!(closeButton instanceof HTMLButtonElement)) {
      throw new TypeError('Expected the stress playground close button.')
    }
    closeButton.click()
    await settle(1)
  ...
  it('introduces the four clamp components in a simple grid guide', async () => {
    ...
    if (!(guide instanceof HTMLElement)) {
      throw new TypeError('Expected the surface guide.')
    }

    const guideList = mountedPage.container.querySelector('[data-surface-guide-list]')
    if (!(guideList instanceof HTMLUListElement)) {
      throw new TypeError('Expected the surface guide list.')
    }

    expect(guide.textContent).toContain('react-clamp')
  ...
  it('surfaces concise API summaries for all components', async () => {
    ...
    if (!(lineSummary instanceof HTMLElement)) {
      throw new TypeError('Expected the LineClamp API summary.')
    }
    ...
    if (!(pretextNotice instanceof HTMLElement)) {
      throw new TypeError('Expected the Pretext typography alert.')
    }
    ...
    if (!(richSummary instanceof HTMLElement)) {
      throw new TypeError('Expected the RichLineClamp API summary.')
    }
    ...
    if (!(richNotice instanceof HTMLElement)) {
      throw new TypeError('Expected the RichLineClamp alert.')
    }
    ...
    if (!(inlineSummary instanceof HTMLElement)) {
      throw new TypeError('Expected the InlineClamp API summary.')
    }
    ...
    if (!(wrapSummary instanceof HTMLElement)) {
      throw new TypeError('Expected the WrapClamp API summary.')
    }
  ...
  it('copies installation and example code from the website code blocks', async () => {
    ...
    expect(clipboardWrites[0]).toBe('npm install react-clamp')
    ...
    expect(clipboardWrites[1]).toBe('bun add react-clamp')

    const lineExampleButton = copyButton(mountedPage.container, 'line-example')
    lineExampleButton.click()
    await settle(2)

    expect(clipboardWrites[2]).toContain('import { LineClamp } from "react-clamp"')
    ...
    expect(clipboardWrites[3]).toContain('import { LineClamp } from "react-clamp/pretext"')
    ...
    expect(clipboardWrites[4]).toContain('import { RichLineClamp } from "react-clamp"')
    ...
    expect(clipboardWrites[5]).toContain('import { InlineClamp } from "react-clamp"')
    ...
    expect(clipboardWrites[6]).toContain('import { WrapClamp } from "react-clamp"')
