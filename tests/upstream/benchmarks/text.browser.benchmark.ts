import type { PreparedText, TextClampHint, TextClampResult } from '../../../src/engine/text'
import type { App, Ref } from '../react-adapter'
import { afterAll, afterEach, beforeAll, describe, expect, it } from 'vitest'
import * as textHelpers from '../../../src/engine/text'
import { InlineClamp, LineClamp } from '../../../src/index'
...
interface ComponentScenarioSpec {
...
interface ScrollWidthDescriptor {
...
const inlineText
  = '/workspace/packages/vue-clamp/src/components/very-long-generated-artifact-name.browser.test'
...
function rootElement(container: HTMLElement): HTMLElement {
  ...
  if (!(root instanceof HTMLElement)) {
    throw new TypeError('Expected benchmark component root.')
  }
