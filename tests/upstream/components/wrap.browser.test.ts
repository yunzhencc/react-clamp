import type { WrapClampHandle as WrapClampExposed, WrapClampState as WrapClampSlotProps } from '../../../src/index'
import type { WrapClampItemSlotProps, FixtureWrapClampProps as WrapClampProps } from '../fixture-types'
import type { App, DefineComponent, Ref, VNodeChild } from '../react-adapter'
...
function rootElement(container: HTMLElement): HTMLElement {
  ...
  if (!(root instanceof HTMLElement)) {
    throw new TypeError('Expected wrap clamp root element.')
  }
...
function wrapContent(root: HTMLElement): HTMLElement {
  ...
  if (!(content instanceof HTMLElement)) {
    throw new TypeError('Expected wrap clamp content element.')
  }
