import type { SimpleLineFit } from '../../../src/engine/layout.ts'
import type { PreparedText, TextClampLayoutInput, TextClampResult } from '../../../src/engine/text.ts'
...
interface CandidateAdvanceStats {
  readonly max: number
  readonly min: number
}
...
async function expectStaleHintIgnored(
  ...
  const layout = {
    ...
    ratio: 1,
    ...current,
  } satisfies Required<Omit<LayoutOverrides, 'maxHeight'>> & Pick<TextClampLayoutInput, 'maxHeight'>
